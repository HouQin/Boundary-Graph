...
def train_model(
        ...
        for phase in epoch_stats.keys():
            ...
            for idx, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    # Attadj = model.propagation.Attadj_matrix
    ...
    valtest_preds_ood = get_predictions(model, attr_mat_norm, idx_all['valtest_ood'])
    valtest_acc_ood = (valtest_preds_ood == labels_all[idx_all['valtest_ood']]).mean()
    ...
    result['valtest_ood'] = {'accuracy': valtest_acc_ood}
    result['runtime'] = runtime
    result['runtime_perepoch'] = runtime_perepoch
    # result['Attention_adj'] = Attadj
